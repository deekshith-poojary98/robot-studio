...
| Signature help | **Robot:** argument hints while the caret is in a keyword call. **Python:** parameter hints for defs/calls resolved from the open buffer |
