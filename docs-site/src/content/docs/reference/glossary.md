...
| **Impact Analysis** | Given a keyword at the caret, lists tests that would be affected if it changed (direct / transitive), with confidence — see [Impact Analysis](/workflows/impact-analysis/) |
