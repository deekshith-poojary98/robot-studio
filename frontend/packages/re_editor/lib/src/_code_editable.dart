          ...
          return Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  // Nested RepaintBoundary + caret painter breaks under Windows
                  // Impeller OpenGLESSDF: caret paints but is not composited until
                  // a parent layout. Skip the boundary on Windows.
