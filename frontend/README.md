...
- **Libraries** side rail (View → Libraries): browse BuiltIn + imported libraries, search keywords, read docs/arguments, Jump to source when available. Filtering lives in `LibraryExplorerController`; detail renders keyword metadata directly.
