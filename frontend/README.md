...
- **Test Explorer** (Tests rail): lazy suite expand (children load on demand) + virtualized rows; PASS/FAIL/SKIP/NOT RUN/RUNNING; toolbar Run All / Run Current File / Run Failed / Refresh / Expand / Collapse; confirms before large project runs (>100 tests); live filter by suite, test, tag, or file.
