...
class RestGateway:
    ...
    async def list_python_interpreters(self):
        return await self._environment_service.list_python_interpreters()
    ...
    async def git_list_remotes(self):
        return await self._git_service.list_remotes()
